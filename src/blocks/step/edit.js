...
export default function Edit({ attributes, setAttributes, clientId }) {
	...
	const deskStyles = `
		.${uniqueId}{
			...
			border-radius: ${containerBorderRadius ? `${containerBorderRadius}px ` : ''};
		}

		.${uniqueId}:hover{
			background-color: ${containerHoverBgColor ? containerHoverBgColor : ''};
		}
		...
		<Fragment>
			...
			<div {...blockProps}>
				...
				<RichText
					...
					placeholder={__('step text..', 'aff-blocks')}
				/>
				<RichText
					tagName="p"
